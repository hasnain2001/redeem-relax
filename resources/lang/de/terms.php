...
return [
    ...
    'welcome_title' => 'Willkommen bei Redeem relax ',
    'welcome_text' => 'Diese Allgemeinen Geschäftsbedingungen ("Bedingungen") regeln die Nutzung der Website von Redeem relax  (die "Website") und aller damit verbundenen Dienstleistungen, die von Redeem relax  ("Redeem relax ", "wir", "uns" oder "unser") bereitgestellt werden. Durch den Zugriff auf oder die Nutzung der Website stimmen Sie diesen Bedingungen zu. Wenn Sie diesen Bedingungen nicht zustimmen, nutzen Sie die Website bitte nicht.',
    ...
    'content_text' => 'Sie erkennen an, dass alle Inhalte auf der Website, einschließlich, aber nicht beschränkt auf Text, Bilder, Grafiken, Logos und Software, Eigentum von Redeem relax  oder seinen Lizenzgebern sind und durch Urheberrechte, Markenrechte und andere geistige Eigentumsrechte geschützt sind. Sie dürfen die Inhalte auf der Website ohne ausdrückliche schriftliche Zustimmung von Redeem relax  weder ändern, reproduzieren, verbreiten noch abgeleitete Werke auf deren Grundlage erstellen.',
    'user_submitted_content_title' => '5. Vom Benutzer eingereichte Inhalte',
    'user_submitted_content_text' => 'Durch das Einreichen von Inhalten auf der Website, einschließlich, aber nicht beschränkt auf Bewertungen, Kommentare und Bewertungen, gewähren Sie Redeem relax  das nicht-exklusive, lizenzfreie, ewige, unwiderrufliche und vollständig unterlizenzierbare Recht, diese Inhalte weltweit in allen Medien zu nutzen, zu reproduzieren, zu ändern, anzupassen, zu veröffentlichen, zu übersetzen, abgeleitete Werke zu erstellen, zu verteilen und anzuzeigen.',
    'links_to_third_party_websites_title' => '6. Links zu Websites von Drittanbietern',
    'links_to_third_party_websites_text' => 'Die Website kann Links zu Websites oder Ressourcen von Drittanbietern enthalten. Sie erkennen an und stimmen zu, dass Redeem relax  nicht verantwortlich oder haftbar ist für: (i) die Verfügbarkeit oder Genauigkeit dieser Websites oder Ressourcen; oder (ii) die Inhalte, Produkte oder Dienstleistungen auf diesen Websites oder Ressourcen. Das Setzen von Links zu diesen Websites oder Ressourcen impliziert nicht, dass Redeem relax  diese Websites oder Ressourcen oder die dort verfügbaren Produkte oder Dienstleistungen billigt. Sie übernehmen die volle Verantwortung und das Risiko für die Nutzung dieser Websites oder Ressourcen.',
    'termination_title' => '7. Beendigung',
    'termination_text' => 'Redeem relax  kann Ihren Zugriff auf die Website jederzeit mit oder ohne Grund und mit oder ohne vorherige Benachrichtigung beenden oder aussetzen.',
    'limitation_of_liability_title' => '8. Haftungsbeschränkung',
    'limitation_of_liability_text' => 'In keinem Fall haftet Redeem relax , ihre leitenden Angestellten, Direktoren, Mitarbeiter oder Vertreter Ihnen gegenüber für direkte, indirekte, zufällige, spezielle, strafrechtliche oder Folgeschäden, die sich aus (i) Fehlern, Ungenauigkeiten oder Unstimmigkeiten im Inhalt; (ii) Körperverletzung oder Sachschaden, gleich welcher Art, resultierend aus Ihrem Zugang zur Website und deren Nutzung; (iii) unbefugtem Zugriff auf oder Nutzung unserer gesicherten Server und/oder aller darin gespeicherten persönlichen Informationen; (iv) Unterbrechung oder Aussetzung der Übertragung zur oder von der Website; (v) Fehler, Viren, Trojaner oder ähnliches, die von Dritten an oder durch die Website übertragen werden; und/oder (vi) Fehler oder Auslassungen in Inhalten oder jeglichem Verlust oder Schaden, der durch die Nutzung von Inhalten auf der Website verursacht wird.',
    'indemnification_title' => '9. Schadensersatz',
    'indemnification_text' => 'Sie stimmen zu, Redeem relax , ihre leitenden Angestellten, Direktoren, Mitarbeiter und Vertreter von allen Ansprüchen, Haftungen, Schäden, Verlusten und Kosten, einschließlich, aber nicht beschränkt auf angemessene rechtliche und buchhalterische Kosten, die aus oder im Zusammenhang mit Ihrem Zugriff auf oder Ihrer Nutzung der Website oder Ihrer Verletzung dieser Bedingungen entstehen, schadlos zu halten.',
