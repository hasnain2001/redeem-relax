            ...
            <div class="col-md-2">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{url('employee/blog')}}" class="text-primary">View Details <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{url('employee/category')}}" class="text-info">View Details <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{url('employee/network')}}" class="text-danger">View Details <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{url('employee/coupon')}}" class="text-success">View Details <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-md-2">
                <div class="card shadow-sm border-0">
                    <div class="card-body">
                        ...
                        <a href="{{url('employee/stores')}}" class="text-warning">View Details <i class="fas fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
